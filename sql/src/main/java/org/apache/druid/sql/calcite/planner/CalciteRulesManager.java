...
public class CalciteRulesManager
{
  ...
  /**
   * Rules for scanning via Bindable, taken from {@link org.apache.calcite.plan.RelOptUtil#registerDefaultRules}.
   */
  ...
  public List<Program> programs(final PlannerContext plannerContext)
  {
    ...
    final Program preProgram =
        Programs.sequence(
            ...
            buildHepProgram(REDUCTION_RULES, true, DefaultRelMetadataProvider.INSTANCE)
        );
